  ...
  return (
    <main className="hero-sky relative min-h-screen overflow-hidden px-5 py-8 sm:px-8 sm:py-12">
      <div className="pointer-events-none absolute inset-0 opacity-40">
        ...
        <div className="absolute right-0 top-40 h-52 w-52 rounded-full bg-[#e30613]/30 blur-3xl" />
      </div>

      <div className="relative mx-auto flex min-h-[calc(100vh-4rem)] max-w-5xl flex-col">
        <header className="flex items-center justify-between text-white">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-full bg-[#e30613] text-white shadow-lg">
              <PlaneIcon />
            </span>
            <div>
        ...
        <section className="my-auto grid items-center gap-10 py-12 lg:grid-cols-[1.1fr_0.9fr]">
          <div className="text-white">
            <p className="mb-4 inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/10 px-3 py-1 text-xs uppercase tracking-[0.18em] text-[#ffc9cd]">
              {market.badge}
            </p>
          ...
          <article className="ticket relative rounded-[28px] px-6 py-8 sm:px-8">
            ...
            <div className="flex items-start justify-between border-b border-dashed border-[#1d1d1b]/15 pb-5">
              <div>
                <p className="text-xs uppercase tracking-[0.2em] text-[#e30613]">
                  {market.boardingPass}
                </p>
            ...
            <div className="grid grid-cols-3 gap-3 py-6 text-sm">
              <div>
                <p className="text-xs uppercase tracking-widest text-[#1d1d1b]/50">
                  {market.fromLabel}
                </p>
            ...
            <p className="mt-4 text-center text-xs text-[#1d1d1b]/55">
              {market.ctaHint}
            </p>
          </article>
        </section>
        ...
        <ul className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {market.destinations.map((destination) => (
            ...
            >
              <p className="text-xs uppercase tracking-[0.16em] text-[#ff8a90]">
                {destination.code}
              </p>
